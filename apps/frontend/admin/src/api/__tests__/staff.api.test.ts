...
>;
type DetailQueryFnContext = QueryFunctionContext<readonly ["staff", "detail", number]>;
...
describe("staff.api", () => {
    ...
    describe("staffListQueryOptions", () => {
        ...
        test("queryFn should throw on error response", async () => {
            ...
            const options = staffListQueryOptions();
            await expect(options.queryFn!({} as ListQueryFnContext)).rejects.toEqual({
                message: "API Error",
            });
        });
    ...
    describe("staffDetailQueryOptions", () => {
        ...
        test("queryFn should return data.data on success", async () => {
            ...
            expect(result).toEqual(expect.objectContaining({ id: 42, fullname: "Staff Detail" }));
        });
        ...
        test("queryFn should throw on error response", async () => {
            ...
            await expect(options.queryFn!({} as DetailQueryFnContext)).rejects.toEqual({
                message: "Not found",
            });
        });
    });
    ...
    describe("createStaffFn", () => {
        ...
        test("should return data.data on success", async () => {
            ...
            expect(result).toEqual(expect.objectContaining({ id: 100, fullname: "Created Staff" }));
        });
    ...
    describe("updateStaffFn", () => {
        ...
        test("should return data.data on success", async () => {
            ...
            expect(result).toEqual(expect.objectContaining({ id: 1, fullname: "Updated Staff" }));
        });
        ...
        test("should throw on error response", async () => {
            ...
            await expect(updateStaffFn({ id: 1, fullname: "Fail" })).rejects.toEqual({
