...
>;
type DetailQueryFnContext = QueryFunctionContext<readonly ["roles", "detail", number]>;
...
describe("roles.api", () => {
    ...
    describe("roleDetailQueryOptions", () => {
        ...
        test("queryFn should return data.data on success", async () => {
            ...
            expect(result).toEqual(expect.objectContaining({ id: 42, name: "Role Detail" }));
        });
    ...
    describe("updateRoleFn", () => {
        ...
        test("should return data.data on success", async () => {
            ...
            expect(result).toEqual(expect.objectContaining({ id: 1, name: "Updated Role" }));
        });
        ...
        test("should throw on error response", async () => {
            ...
            await expect(updateRoleFn({ id: 1, name: "Fail" })).rejects.toEqual({
